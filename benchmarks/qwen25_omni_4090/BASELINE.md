...
one-token decode at KV 32,761--32,767 use split-16 online-softmax attention.
...
| 32,760 + 8 | 5 paired | 2.6033 s | 2.6020 s | unchanged | 14.089 ms |
...
`PROFILE.md` and `promotion-decode-split-cta.json` for the latest promotion
evidence.
