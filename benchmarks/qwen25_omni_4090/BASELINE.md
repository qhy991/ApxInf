...
one-token decode at KV 32,761--32,767 use split-32 online-softmax attention.
...
| 32,760 + 8 | 5 paired | 2.6035 s | 2.6025 s | unchanged | 11.705 ms |
...
`PROFILE.md` and `promotion-decode-split32.json` for the latest promotion
evidence.
